        ...
        <div className='chef-section-container' id="chefs">
            ...
            <div className='chef-section-grid-container'>
                ...
                <div className='chef-description'>
                    <h3>Lisa Quinn <br/> 20 years of experience</h3>
                    <span>Rating: 4.7<AiFillStar/></span>
                    <p> Based in Toronto, she manages every time to delight her customers with colorful and delicious dishes. 
                ...
                <div className='chef-description'>
                    <h3>Ben Malone <br/> 8 years of experience</h3>
                    <span>Rating: 4.2 <AiFillStar/></span>
                    <p>Based in Springfield, Ben is one of our youngest chefs in our team . He has a special talent and love for Asian food, famous for its combination of  spices,
                ...
                <div className='chef-description'>
                    <h3>Liam Pierce <br/> 15 years of experience</h3>
